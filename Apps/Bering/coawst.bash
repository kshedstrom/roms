...
export   COAWST_APPLICATION=BERING
...
export     MY_ROOT_DIR=/center/w/kate/COAWST
...
#  export MY_ANALYTICAL_DIR=${MY_PROJECT_DIR}/ROMS/Functionals
   export     MY_HEADER_DIR=${MY_PROJECT_DIR}/Projects/Bering
   export MY_ANALYTICAL_DIR=${MY_PROJECT_DIR}/Projects/Bering

# Put the binary to execute in the following directory.

# export            BINDIR=${MY_PROJECT_DIR}
  export            BINDIR=${MY_ANALYTICAL_DIR}

# Put the f90 files in a project specific Build directory to avoid conflict
# with other projects.

# export       SCRATCH_DIR=${MY_PROJECT_DIR}/Build
  export       SCRATCH_DIR=./Build_Bering
