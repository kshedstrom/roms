...
!
!! svn $Id: ana_grid.h 221 2007-04-27 04:06:08Z arango $
!!======================================================================
...
#include "tile.h"
!
      CALL ana_grid_tile (ng, model, tile,                              &
     &                    LBi, UBi, LBj, UBj,                           &
...
!
!***********************************************************************
      SUBROUTINE ana_grid_tile (ng, model, tile,                        &
     &                          LBi, UBi, LBj, UBj,                     &
     &                          IminS, ImaxS, JminS, JmaxS,             &
     &                          angler,                                 &
#if defined CURVGRID && defined UV_ADV
...
!-----------------------------------------------------------------------
!
#if defined defined WBC_2 || defined WBC_3
      DO j=Jstr-1,Jend+1
        DO i=Istr-1,Iend+1
          wrkX(i,j)=2.0e-5_r8
          wrkY(i,j)=2.0e-5_r8
