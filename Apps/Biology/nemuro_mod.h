...
!
      ...
      real(r8), dimension(max_species, Ngrids) :: FspTmin       !  deg.C
      real(r8), dimension(max_species, Ngrids) :: FspTmax       !  deg.C
      integer, dimension(max_species, Ngrids)  :: Hbehave       !  Hor.behave
      integer, dimension(max_species, Ngrids)  :: Vbehave       !  Vert.behave
      real(r8), dimension(max_lstages, max_species, Ngrids) :: ZSpref
      real(r8), dimension(max_species, Ngrids) :: ZSpref_L
      real(r8), dimension(max_species, Ngrids) :: ZSpref_J
      real(r8), dimension(max_species, Ngrids) :: ZSpref_A
      real(r8), dimension(max_lstages, max_species, Ngrids) :: ZLpref
      real(r8), dimension(max_species, Ngrids) :: ZLpref_L
      real(r8), dimension(max_species, Ngrids) :: ZLpref_J
      real(r8), dimension(max_species, Ngrids) :: ZLpref_A
      real(r8), dimension(max_lstages, max_species, Ngrids) :: ZPpref
      real(r8), dimension(max_species, Ngrids) :: ZPpref_L
      real(r8), dimension(max_species, Ngrids) :: ZPpref_J
      real(r8), dimension(max_species, Ngrids) :: ZPpref_A
      real(r8), dimension(max_lstages, max_species, Ngrids) :: K_ZS
      real(r8), dimension(max_species, Ngrids) :: K_ZS_L
      real(r8), dimension(max_species, Ngrids) :: K_ZS_J
      real(r8), dimension(max_species, Ngrids) :: K_ZS_A
      real(r8), dimension(max_lstages, max_species, Ngrids) :: K_ZL
      real(r8), dimension(max_species, Ngrids) :: K_ZL_L
      real(r8), dimension(max_species, Ngrids) :: K_ZL_J
      real(r8), dimension(max_species, Ngrids) :: K_ZL_A
      real(r8), dimension(max_lstages, max_species, Ngrids) :: K_ZP
      real(r8), dimension(max_species, Ngrids) :: K_ZP_L
      real(r8), dimension(max_species, Ngrids) :: K_ZP_J
      real(r8), dimension(max_species, Ngrids) :: K_ZP_A
      real(r8), dimension(max_species, Ngrids) :: Cal_Z
      real(r8), dimension(max_species, Ngrids) :: Cal_F
      real(r8), dimension(max_lstages, max_species, Ngrids) :: a_C
      real(r8), dimension(max_species, Ngrids) :: a_C_L
      real(r8), dimension(max_species, Ngrids) :: a_C_J
      real(r8), dimension(max_species, Ngrids) :: a_C_A
      real(r8), dimension(max_lstages, max_species, Ngrids) :: b_C
      real(r8), dimension(max_species, Ngrids) :: b_C_L
      real(r8), dimension(max_species, Ngrids) :: b_C_J
      real(r8), dimension(max_species, Ngrids) :: b_C_A
      real(r8), dimension(max_lstages, max_species, Ngrids) :: pvalmax
      real(r8), dimension(max_species, Ngrids) :: pvalmax_L
      real(r8), dimension(max_species, Ngrids) :: pvalmax_J
      real(r8), dimension(max_species, Ngrids) :: pvalmax_A
      real(r8), dimension(max_lstages, max_species, Ngrids) :: a_R
      real(r8), dimension(max_species, Ngrids) :: a_R_L
      real(r8), dimension(max_species, Ngrids) :: a_R_J
      real(r8), dimension(max_species, Ngrids) :: a_R_A
      real(r8), dimension(max_lstages, max_species, Ngrids) :: b_R
      real(r8), dimension(max_species, Ngrids) :: b_R_L
      real(r8), dimension(max_species, Ngrids) :: b_R_J
      real(r8), dimension(max_species, Ngrids) :: b_R_A
      real(r8), dimension(max_lstages, max_species, Ngrids) :: activity
      real(r8), dimension(max_species, Ngrids) :: activity_L
      real(r8), dimension(max_species, Ngrids) :: activity_J
      real(r8), dimension(max_species, Ngrids) :: activity_A
      real(r8), dimension(max_lstages, max_species, Ngrids) :: d_R
      real(r8), dimension(max_species, Ngrids) :: d_R_L
      real(r8), dimension(max_species, Ngrids) :: d_R_J
      real(r8), dimension(max_species, Ngrids) :: d_R_A
      real(r8), dimension(max_lstages, max_species, Ngrids) :: Fswim
      real(r8), dimension(max_species, Ngrids) :: Fswim_L
      real(r8), dimension(max_species, Ngrids) :: Fswim_J
      real(r8), dimension(max_species, Ngrids) :: Fswim_A
      real(r8), dimension(max_lstages, max_species, Ngrids) :: a_AE
      real(r8), dimension(max_species, Ngrids) :: a_AE_L
      real(r8), dimension(max_species, Ngrids) :: a_AE_J
      real(r8), dimension(max_species, Ngrids) :: a_AE_A
      real(r8), dimension(max_lstages, max_species, Ngrids) :: b_AE
      real(r8), dimension(max_species, Ngrids) :: b_AE_L
      real(r8), dimension(max_species, Ngrids) :: b_AE_J
      real(r8), dimension(max_species, Ngrids) :: b_AE_A
      real(r8), dimension(max_lstages, max_species, Ngrids) :: AEmax
      real(r8), dimension(max_species, Ngrids) :: AEmax_L
      real(r8), dimension(max_species, Ngrids) :: AEmax_J
      real(r8), dimension(max_species, Ngrids) :: AEmax_A
      real(r8), dimension(max_lstages, max_species, Ngrids) :: te1
      real(r8), dimension(max_species, Ngrids) :: te1_L
      real(r8), dimension(max_species, Ngrids) :: te1_J
      real(r8), dimension(max_species, Ngrids) :: te1_A
      real(r8), dimension(max_lstages, max_species, Ngrids) :: te2
      real(r8), dimension(max_species, Ngrids) :: te2_L
      real(r8), dimension(max_species, Ngrids) :: te2_J
      real(r8), dimension(max_species, Ngrids) :: te2_A
      real(r8), dimension(max_lstages, max_species, Ngrids) :: te3
      real(r8), dimension(max_species, Ngrids) :: te3_L
      real(r8), dimension(max_species, Ngrids) :: te3_J
      real(r8), dimension(max_species, Ngrids) :: te3_A
      real(r8), dimension(max_lstages, max_species, Ngrids) :: te4
      real(r8), dimension(max_species, Ngrids) :: te4_L
      real(r8), dimension(max_species, Ngrids) :: te4_J
      real(r8), dimension(max_species, Ngrids) :: te4_A
      real(r8), dimension(max_lstages, max_species, Ngrids) :: xk1
      real(r8), dimension(max_species, Ngrids) :: xk1_L
      real(r8), dimension(max_species, Ngrids) :: xk1_J
      real(r8), dimension(max_species, Ngrids) :: xk1_A
      real(r8), dimension(max_lstages, max_species, Ngrids) :: xk2
      real(r8), dimension(max_species, Ngrids) :: xk2_L
      real(r8), dimension(max_species, Ngrids) :: xk2_J
      real(r8), dimension(max_species, Ngrids) :: xk2_A
      real(r8), dimension(max_lstages, max_species, Ngrids) :: xk3
      real(r8), dimension(max_species, Ngrids) :: xk3_L
      real(r8), dimension(max_species, Ngrids) :: xk3_J
      real(r8), dimension(max_species, Ngrids) :: xk3_A
      real(r8), dimension(max_lstages, max_species, Ngrids) :: xk4
      real(r8), dimension(max_species, Ngrids) :: xk4_L
      real(r8), dimension(max_species, Ngrids) :: xk4_J
      real(r8), dimension(max_species, Ngrids) :: xk4_A
      real(r8), dimension(max_lstages, max_species, Ngrids) :: cr
      real(r8), dimension(max_species, Ngrids) :: cr_L
      real(r8), dimension(max_species, Ngrids) :: cr_J
      real(r8), dimension(max_species, Ngrids) :: cr_A
      real(r8), dimension(max_lstages, max_species, Ngrids) :: tr
      real(r8), dimension(max_species, Ngrids) :: tr_L
      real(r8), dimension(max_species, Ngrids) :: tr_J
      real(r8), dimension(max_species, Ngrids) :: tr_A
      real(r8), dimension(max_species, Ngrids) :: Wffeed
      real(r8), dimension(max_species, Ngrids) :: Lffeed
      real(r8), dimension(max_species, Ngrids) :: WeightLJ
      real(r8), dimension(max_species, Ngrids) :: LengthLJ
      real(r8), dimension(max_species, Ngrids) :: WeightJA
      real(r8), dimension(max_species, Ngrids) :: LengthJA
      real(r8), dimension(max_lstages, max_species, Ngrids) :: aw2l
      real(r8), dimension(max_species, Ngrids) :: aw2l_L
      real(r8), dimension(max_species, Ngrids) :: aw2l_J
      real(r8), dimension(max_species, Ngrids) :: aw2l_A
      real(r8), dimension(max_lstages, max_species, Ngrids) :: bw2l
      real(r8), dimension(max_species, Ngrids) :: bw2l_L
      real(r8), dimension(max_species, Ngrids) :: bw2l_J
      real(r8), dimension(max_species, Ngrids) :: bw2l_A
      real(r8), dimension(max_lstages, max_species, Ngrids) :: dSLk
      real(r8), dimension(max_species, Ngrids) :: dSLk_L
      real(r8), dimension(max_species, Ngrids) :: dSLk_J
      real(r8), dimension(max_species, Ngrids) :: dSLk_A
      real(r8), dimension(max_lstages, max_species, Ngrids) :: dSLinf
      real(r8), dimension(max_species, Ngrids) :: dSLinf_L
      real(r8), dimension(max_species, Ngrids) :: dSLinf_J
      real(r8), dimension(max_species, Ngrids) :: dSLinf_A
      real(r8), dimension(max_lstages, max_species, Ngrids) :: al2w
      real(r8), dimension(max_species, Ngrids) :: al2w_L
      real(r8), dimension(max_species, Ngrids) :: al2w_J
      real(r8), dimension(max_species, Ngrids) :: al2w_A
      real(r8), dimension(max_lstages, max_species, Ngrids) :: bl2w
      real(r8), dimension(max_species, Ngrids) :: bl2w_L
      real(r8), dimension(max_species, Ngrids) :: bl2w_J
      real(r8), dimension(max_species, Ngrids) :: bl2w_A
      real(r8), dimension(max_species, Ngrids) :: abatch
      real(r8), dimension(max_species, Ngrids) :: bbatch
      real(r8), dimension(max_species, Ngrids) :: T0batch
      real(r8), dimension(max_species, Ngrids) :: apof
      real(r8), dimension(max_species, Ngrids) :: bpof
      real(r8), dimension(max_species, Ngrids) :: T0pof
      real(r8), dimension(max_species, Ngrids) :: epg
      real(r8), dimension(max_species, Ngrids) :: eegg
      real(r8), dimension(max_species, Ngrids) :: megg
      real(r8), dimension(max_species, Ngrids) :: breed
      real(r8), dimension(max_species, Ngrids) :: amature
      real(r8), dimension(max_species, Ngrids) :: bmature
      real(r8), dimension(max_species, Ngrids) :: pctxwt
      real(r8), dimension(max_species, Ngrids) :: pctgain
      real(r8), dimension(max_lstages, max_species, Ngrids) :: Nmort
      real(r8), dimension(max_species, Ngrids) :: Nmort_E
      real(r8), dimension(max_species, Ngrids) :: Nmort_Y
      real(r8), dimension(max_species, Ngrids) :: Nmort_L
      real(r8), dimension(max_species, Ngrids) :: Nmort_J
      real(r8), dimension(max_species, Ngrids) :: Nmort_A
...
# ifdef PREDATOR
      ...
      real(r8), dimension(max_predspecies, Ngrids) :: Pwth0     ! worth
      real(r8), dimension(max_predspecies, Ngrids) :: Pswim     ! cm s-1
      real(r8), dimension(max_predspecies, Ngrids) :: HIF       ! HIF
      real(r8), dimension(max_predspecies, Ngrids) :: FEUE1     ! FEUE1
      real(r8), dimension(max_predspecies, Ngrids) :: FEUE2     ! FEUE2
      real(r8), dimension(max_predspecies, Ngrids) :: FEUE3     ! FEUE3
      real(r8), dimension(max_predspecies, Ngrids) :: FEUE4     ! FEUE4
      real(r8), dimension(max_predspecies, Ngrids) :: PED1      ! PED1
      real(r8), dimension(max_predspecies, Ngrids) :: PED2      ! PED2
      real(r8), dimension(max_predspecies, Ngrids) :: PED3      ! PED3
      real(r8), dimension(max_predspecies, Ngrids) :: PED4      ! PED4
      real(r8), dimension(max_predspecies, Ngrids) :: Eprot     ! Eprot
      real(r8), dimension(max_predspecies, Ngrids) :: Efat      ! Efat
      real(r8), dimension(max_predspecies, Ngrids) :: RefpFat   ! RefpFat
      real(r8), dimension(max_predspecies, Ngrids) :: RefpPr    ! RefpPr
      real(r8), dimension(max_predspecies, Ngrids) :: Linf      ! Linf
      real(r8), dimension(max_predspecies, Ngrids) :: vbk       ! vbk
      real(r8), dimension(max_predspecies, Ngrids) :: vbt0      ! vbt0
      real(r8), dimension(max_predspecies, Ngrids) :: al2m      ! al2m
      real(r8), dimension(max_predspecies, Ngrids) :: bl2m      ! bl2m
      real(r8), dimension(max_predspecies, Ngrids) :: Pmgstr    ! day
      real(r8), dimension(max_predspecies, Ngrids) :: Pmgend    ! day
      real(r8), dimension(max_species, Ngrids) :: Fpref
      real(r8), dimension(max_species, Ngrids) :: K_Fish
      real(r8), dimension(max_predspecies, Ngrids) :: Pcmax     ! g g-1 day-1
# endif
# ifdef FLEET
